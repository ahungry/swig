...
(def chunk (curl/new-curl-slist))
(curl/curl-slist-append chunk "Content-Type: application/json")

(curl/curl-easy-setopt-pointer c (curl/const-CURLOPT-HTTPHEADER) chunk)
